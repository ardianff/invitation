...
const TITLE = ["05.09.2026", "SABTU", "09:00 WIB - SELESAI"];
const CalendarSection = () => {
  ...
  return (
    <section id="calendar-section" ref={ref} className="w-full px-24pxr text-center">
      ...
      <SlideUp show={transitionIds.includes(TITLE.length)} className="w-full">
        <Calendar>
          ...
          <Calendar.Dates startDate={-1} endDate={30} activeDate={5} />
        </Calendar>
      </SlideUp>
    </section>
  );
